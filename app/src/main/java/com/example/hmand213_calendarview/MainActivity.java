package com.example.hmand213_calendarview;
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cStartDate>cFinishDate) {
                    ...
                    Toast.makeText(MainActivity.this, " Старт"+cStartTitle + " "+" Окончание" +cFinishTitle,Toast.LENGTH_LONG).show();
                }
            }
        });
    }
